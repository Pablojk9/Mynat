...
const ProductosList = () => {
  ...
  const handleSolicitarClick = (id, nombreProducto) => {
            ...
            {productos.map(producto => (
              <div key={producto.id_producto} className="column is-4">
                <div className="producto-item box">
                  ...
                  {producto.stock === 1 ? (
                    <button className="button-solicitar" onClick={() => handleSolicitarClick(producto.id_producto, producto.nombre_producto)}>
